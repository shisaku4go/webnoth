...
export const races: WesnothRace[] = [
  ...
  },
  {
    ...
    pluralName: 'Cats',
    description:
      'Big cats are nimble, solitary predators that can cause trouble for any farmer or hunter that encounter them. The cats that hunt rodents and drive away lone wolves are tolerated by civilized folk, but some big cats are considered terrifying monsters.',
    numTraits: 2,
    undeadVariation: 'cat',
  },
  {
  ...
  },
  {
    ...
    traits: ['TRAIT_WEAK', 'TRAIT_SLOW', 'TRAIT_DIM'],
  ...
  },
  {
    ...
    description:
      "Animated neither by natural life nor by necromancy, the term text='mechanical' describes a created artifact of an intelligent being. Most mechanical things neither move nor think on their own, but some do so as a result of magical enchantment.",
    numTraits: 1,
    traits: ['TRAIT_MECHANICAL'],
    ignoreGlobalTraits: true,
  },
  {
    id: 'merman',
  ...
  },
  {
    ...
    pluralName: 'Monsters',
    description:
      'The term “monster” incorporates many hideous beasts that haunt the caves, wilderness, ocean depths, and other climes of the world. They figure largely in the tales and nightmares of its denizens, as well.',
    numTraits: 0,
  },
  {
    id: 'naga',
  ...
  },
  {
    ...
    pluralName: 'Ships',
    description:
      'Ships are not living beings, but they are crafted and (usually) controlled by living beings. Most ships neither move nor think on their own, but some do so as a result of magical enchantment.',
    numTraits: 2,
    traits: ['TRAIT_MECHANICAL'],
    ignoreGlobalTraits: true,
