...
export const traits: WesnothTrait[] = [
  ...
  },
  {
    ...
    helpText:
      'Dwellings of sentient beings are not easily used for cover by feral creatures of low intelligence. As a result, feral units receive a maximum of 50% defense in any land-based village regardless of base terrain.',
    availability: 'musthave',
    effects: [
      {
        applyTo: 'defense',
  ...
  },
  {
    ...
    femaleName: 'weak',
    helpText:
      'Units with the weak trait receive a 1 point decrease in hitpoints and melee damage.',
    effects: [
      {
        applyTo: 'attack',
        increaseDamage: -1,
  ...
  },
  {
    ...
    femaleName: 'aged',
    helpText:
      'Units with the aged trait have 8 hitpoints less and suffer from a 1 point decrease in movement and melee damage.',
    effects: [
      {
        applyTo: 'hitpoints',
        increaseTotal: -8,
  ...
  },
  {
    ...
    name: 'oceangoing',
    description:
      'This unit is limited to 20% defense while in ford, bridge, oasis, or water-based village/castle terrain.',
    availability: 'musthave',
    effects: [
      {
        applyTo: 'new_ability',
  ...
  },
  {
    ...
    name: 'push-poles',
    description:
      'This unit has 30% defense while in ford, bridge, oasis, or water-based village/castle terrain.',
    availability: 'musthave',
    effects: [
      {
        applyTo: 'new_ability',
