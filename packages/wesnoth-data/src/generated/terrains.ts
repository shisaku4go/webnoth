...
export const terrains: WesnothTerrain[] = [
  ...
  },
  {
    ...
    code: '^Qhh',
    aliasOf: ['_bas'],
    editorGroup: ['embellishments', 'elevation'],
  },
  {
    id: 'high_canyon',
    name: 'Gulch',
  ...
  },
  {
    ...
    editorGroup: ['water'],
    helpTopicText:
      "text='Coastal reefs' are shallows formed by stone, coral and sand.\nThis provides most land units with a more steady footing and defensive positions than wading in shallow water normally would and also grants most water-dwelling races an exceptionally high defense.\n\nMerfolk and Naga both receive 70% defense on coastal reefs.",
  },
  {
    id: 'hills',
    name: 'Hills',
  ...
  },
  {
    ...
    code: 'Wdt',
    helpTopicText:
      "text='Deep water' represents any body of water deep enough to cover a man’s head.\nMost units cannot enter deep water: it is the domain of units which can either fly, or are exceptionally strong swimmers.\n\nMerfolk and naga both receive 50% defense in deep water, with full movement.",
  },
  {
    id: 'flat',
    name: 'Flat',
  ...
  },
  {
    ...
    code: 'Qt',
    helpTopicText:
      "text='Unwalkable terrain' covers any chasm or gorge which, as the name implies, cannot be crossed simply by walking. Chasms are noted for sheer walls which would take days to traverse. As far as gameplay is concerned, only units capable of flying can cross this terrain.",
  },
  {
    id: 'rails',
    name: 'Rails',
